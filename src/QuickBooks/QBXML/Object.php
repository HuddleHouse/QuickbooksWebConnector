...
abstract class QuickBooks_QBXML_Object
{
	 ...
	 * @return string
	 */
	public function gettime_created($format = null)
	{
		if (!is_null($format))
		{
			return date($format, strtotime($this->get('time_created')));
		}
	 ...
	 * @return string
	 */	
	public function gettime_modified($format = null)
	{
		if (!is_null($format))
		{
			return date($format, strtotime($this->get('time_modified')));
		}
		
		return $this->get('time_modified');
	}
